...
public:
    ...
    GreenDragon():Dragon("Green", c_greenDragonHealth, c_greenDragonAttackForce)
    {}
    std::string generateQuestion()
    {
        int left = 1 + rand()%100;
...
class RedDragon : public Dragon
{
    ...
    static const int c_redDragonAttackForce = 8;
public:
...
{
    static const int c_blackDragonHealth = 60;
    static const int c_blackDragonAttackForce = 10;
public:
